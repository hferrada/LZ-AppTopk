...
public:
	...
	public:
		...
		uint lenUPath;
		uchar *uSymbols;
		ulong nOccT1;		// number of occurrences type 1
		uint kStar;			// number of different documents that this node store as pre-computed answer
		LZNode* nodeLZ;
		RevNode** hTabRev;
		RevNode* fChildRev;
		RevNode* nextSibRev;
	...
	void createTriesFromText(uchar* text, ulong n, ulong** nodeArr, ulong *endDocs, ulong *endDocsPos, bit_vector *separator_b);
